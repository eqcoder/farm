...
class EnterYajangImage extends StatelessWidget{
  Uint8List? _editedImage;
  Future<void> _getImage(ImageSource source) async {
  final ImagePicker _picker = ImagePicker();
    final XFile? pickedFile = await _picker.pickImage(source: source);
    if (pickedFile != null) {
        _editedImage= img.encodeJpg(cleanImage(pickedFile.path));
    }
  }
  Widget build(BuildContext context){
    return Column(
...
class AndroidEnterDataLayout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
        ...
        child: Column(
          children: [
            // 좌측 영역
            Expanded(child:EnterYajangImage(),
              flex: 15,),
...
class WindowsEnterDataLayout extends StatelessWidget {
